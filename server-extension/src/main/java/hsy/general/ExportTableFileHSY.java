 ...
 */
@OskariActionRoute("ExportTableFileHSY")
public class ExportTableFileHSY extends ActionHandler {
    ...
    private static final Logger log = LogFactory.getLogger(ExportTableFileHSY.class);
    ...
    public void handleAction(ActionParameters params) throws ActionException {
        ...
        if (FORMAT_CSV.equals(format)) {
            ...
            fileStreamer = new XLSXStreamerHSY();
