...
@Oskari(OpenStreetMapSearchBboxChannel.ID)
public class OpenStreetMapSearchBboxChannel extends SearchChannel {

    /** logger */
    private Logger log = LogFactory.getLogger(this.getClass());
    private String serviceURL = null;
    public static final String ID = "OPENSTREETMAP_BBOX_CHANNEL";
    public final static String SERVICE_SRS = "EPSG:4326";

    private static final String PROPERTY_SERVICE_URL = "search.channel.OPENSTREETMAP_BBOX_CHANNEL.service.url";
    private static final String PROPERTY_BBOX = "search.channel.OPENSTREETMAP_BBOX_CHANNEL.search.bbox";
    ...
    private JSONArray getData(SearchCriteria searchCriteria) throws Exception {
        ...
        if(filterBBOX != null) {
            ...
            log.warn("Search BBOX not configured. Add property with key",PROPERTY_BBOX);
        }
